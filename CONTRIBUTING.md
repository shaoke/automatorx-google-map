# Contributing to AutomatorX Google map

Love automatorx-google-map and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/shaoke/automatorx-google-map.git/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone git://github.com/<your name>/automatorx-google-map.git
    # Navigate to the newly cloned directory
    cd automatorx-google-map
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/shaoke/automatorx-google-map.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/shaoke/automatorx-google-map.git/blob/master/LICENSE.md).
